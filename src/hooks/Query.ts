...
export default class Query<TData = any, TVariables = OperationVariables> {
  ...
  componentDidMount(props: QueryProps<TData, TVariables>) {
  ...
  onClientUpdated(nextProps:QueryProps<TData, TVariables>, nextClient: ApolloClient<any>) {
  ...
  //   this.startQuerySubscription(nextProps);
  // }
  ...
  componentDidUpdate(props: QueryProps<TData, TVariables>) {
  ...
  updateQuery(props: QueryProps<TData, TVariables>) {
  ...
  startQuerySubscription(props: QueryProps<TData, TVariables>) {
    if (this.querySubscription) return;
    // store the initial renders worth of result
    let initial: QueryResult<TData, TVariables> | undefined = this.getQueryResult(props);
  ...
  getQueryResult = (props: QueryProps<TData, TVariables>): QueryResult<TData, TVariables> => {
    ...
    if (!this.querySubscription) {
      ...
      (data as GraphqlQueryControls).refetch = (args: any) => {
        if (this.querySubscription) {
