(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('apollo-cache-inmemory'), require('react'), require('prop-types'), require('apollo-client'), require('react-dom/server'), require('apollo-link'), require('graphql/language/printer'), require('apollo-utilities')) :
    typeof define === 'function' && define.amd ? define(['exports', 'apollo-cache-inmemory', 'react', 'prop-types', 'apollo-client', 'react-dom/server', 'apollo-link', 'graphql/language/printer', 'apollo-utilities'], factory) :
    (factory((global['react-apollo'] = {}),global.apolloCacheInmemory,global.React,global.PropTypes,global.ApolloClient,global.ReactDOM,global.apolloLink,global.printer,global.apolloUtilities));
}(this, (function (exports,apolloCacheInmemory,React,PropTypes,ApolloClient,ReactDOM,apolloLink,printer,apolloUtilities) { 'use strict';
    ...
    var shallowEqual$3 = require('fbjs/lib/shallowEqual');
    var invariant$9 = require('invariant');
    ...
    function observableQueryFields$1(observable) {
        var fields = {
            variables: observable.variables,
            refetch: observable.refetch.bind(observable),
            fetchMore: observable.fetchMore.bind(observable),
    ...
    var Query$1 = (function () {
        function Query(props, context, forceUpdate) {
            ...
            this.getQueryResult = function (props) {
                var data = { data: Object.create(null) };
                Object.assign(data, observableQueryFields$1(_this.queryObservable));
                if (props.skip) {
                    data = __assign$6({}, data, { data: undefined, error: undefined, loading: false });
                }
                else {
                    var currentResult = _this.queryObservable.currentResult();
                    var loading = currentResult.loading, partial = currentResult.partial, networkStatus = currentResult.networkStatus, errors = currentResult.errors;
        ...
        Query.prototype.extractOptsFromProps = function (props) {
            var variables = props.variables, pollInterval = props.pollInterval, fetchPolicy = props.fetchPolicy, errorPolicy = props.errorPolicy, notifyOnNetworkStatusChange = props.notifyOnNetworkStatusChange, query = props.query, _a = props.displayName, displayName = _a === void 0 ? 'Query' : _a, _b = props.context, context = _b === void 0 ? {} : _b;
            this.operation = parser(query);
            invariant$9(this.operation.type === DocumentType.Query, "The <Query /> component requires a graphql query, but got a " + (this.operation.type === DocumentType.Mutation ? 'mutation' : 'subscription') + ".");
            return compact$1({
                variables: variables,
                pollInterval: pollInterval,
                query: query,
        ...
        Query.prototype.startQuerySubscription = function (props) {
            ...
            this.querySubscription = this.queryObservable.subscribe({
                next: function (_a) {
                    var data = _a.data;
                    if (initial && initial.networkStatus === 7 && shallowEqual$3(initial.data, data)) {
                        initial = undefined;
                        return;
                    }
                    initial = undefined;
